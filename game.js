...
//mouse takibi ile user kontrolu
const movePaddle = (e) => {
...
const update = () => {
    ...
    //alt ve ust duvardan topu dondurme
    if (ball.y + ball.r > cvs.height || ball.y - ball.r < 0) {
        ball.velocityY = -ball.velocityY;
    }

    //level ayarlari bilgisayar cubugununun ortasini topa  gore esitle 
    let comLvl = 0.2;
    com.y += (ball.y - (com.y + com.h / 2)) * comLvl;

    //top hangi bolgeye yakin
    let player = (ball.x < cvs.width / 2) ? user : com
    
    //carpisma sonrasi topun geri donus acilarini hesapliyoruz
